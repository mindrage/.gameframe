...
static bgfx::UniformHandle g_AttributeLocationTex = BGFX_INVALID_HANDLE;
static bgfx::VertexLayout g_VertexLayout;
static const bgfx::EmbeddedShader g_ImguiEmbeddedShaders[] = {
...
bool ImGui_Implbgfx_CreateDeviceObjects()
{
    ...
    g_ShaderHandle = bgfx::createProgram(
        bgfx::createEmbeddedShader(g_ImguiEmbeddedShaders, type, "vs_ocornut_imgui"),
        bgfx::createEmbeddedShader(g_ImguiEmbeddedShaders, type, "fs_ocornut_imgui"),
        true);
    ...
    g_AttributeLocationTex = bgfx::createUniform("g_AttribLocationTex", bgfx::UniformType::Sampler);
...
{
    bgfx::destroy(g_AttributeLocationTex);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++) {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++) {
            ...
            if (pcmd->UserCallback) {
                ...
                bgfx::setTexture(0, g_AttributeLocationTex, texture);
